...
function modelInstructions(availability, verifiedEvidence) {
  ...
  return [
    ...
    'Calibration identity fields are server-owned legacy structure. Populate them only as required by the strict schema; they do not authorize visible calibration copy or placement.',
    ...
    'Write semantic body paragraphs and the personal seal in natural, direct Turkish in the established GrandMastrolog consultant voice.',
    'Every included section body must interpret verified evidence into specific real-life meaning. Never merely restate the Hat, repeat placement labels, or return placeholder/meta sentences saying a topic is summarized, examined, handled, effective, shaped, or explained.',
    'Do not write generic horoscope/Barnum filler. A claim must be materially specific to the verified combination cited by that section.',
    'Each included section must add distinct new value. Do not paraphrase another section or spread one synthesis across the whole chart.',
    'PROFİLİN selects the external/internal structure, reaction-decision pattern, trust-bond pattern, and a concrete strength/challenge combination.',
    'HARİTANIN ÖZÜ is not a second profile or career list. Distill the core operating law, main hard-to-change tension, strongest usable resource, and recurring primary life scene without repeating PROFİLİN.',
    'PARA & KARİYER stays on work, career and resource patterns; İLİŞKİLER stays on relationship dynamics; AİLE stays on roots/home/family dynamics without inventing family history; KARMALAR stays on node/Saturn/Pluto repetition-learning patterns without moral or fatalistic certainty.',
    'Never invent biography, events, aspects, rulers, dignities, element percentages, transits, timing, or any other technique not explicitly present in VERIFIED_EVIDENCE.',
    'The personal seal must be a concise person-specific Sun+Ascendant synthesis. Do not use generic fate, stars, destiny, energy, leadership, transformation, balance, lesson, or opportunity slogans unless the verified combination makes the meaning concrete.',
